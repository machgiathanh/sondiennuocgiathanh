...
export default function hello() {
  const product12 = product_list[12];
  return (
    <div>
      ...
      >
        <Col md={8} xs={24}>
          <Gallery images={product12.gallery}></Gallery>
        </Col>
        <Col md={16} xs={24} gutter={15}>
          <div>
            <Typography.Title level={3}>{product12.name}</Typography.Title>
            <Typography
              style={{
                color: "#1435c3",
                fontSize: 20,
            ...
            <Typography.Text level={5}>
              <span style={{ textDecoration: "line-through", color: "#999" }}>
                {product12.price_sale}
              </span>
              {product12.discount_percent}
            </Typography.Text>
          </div>
          <h4>
      ...
      >
        ...
        <Col md={8} xs={24} style={{ width: "100%" }}>
          ...
          {product12.attributes.map((item, index) => (
            <Row
              key={index}
              style={{
                padding: 8,
