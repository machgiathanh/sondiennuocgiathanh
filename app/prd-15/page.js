...
export default function hello() {
  const product14 = product_list[14];
  return (
    <div>
      ...
      >
        <Col md={8} xs={24}>
          <Gallery images={product14.gallery}></Gallery>
        </Col>
        <Col md={16} xs={24} gutter={15}>
          <div>
            <Typography.Title level={3}>{product14.name}</Typography.Title>
            <Typography
              style={{
                color: "#1435c3",
                fontSize: 20,
            ...
            <Typography.Text level={5}>
              <span style={{ textDecoration: "line-through", color: "#999" }}>
                {product14.price_sale}
              </span>
              {product14.discount_percent}
            </Typography.Text>
          </div>
          <h4>
      ...
      >
        ...
        <Col md={8} xs={24} style={{ width: "100%" }}>
          ...
          {product14.attributes.map((item, index) => (
            <Row
              style={{
                padding: 8,
