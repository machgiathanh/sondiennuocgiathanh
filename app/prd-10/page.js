...
export default function hello() {
  ...
  return (
    <div>
      ...
      >
        <Col md={8} xs={24}>
          <Gallery images={product9.gallery}></Gallery>
        </Col>
        <Col md={16} xs={24} gutter={15}>
          <div>
            <Typography.Title level={3}>{product9.name}</Typography.Title>
            <Typography
              style={{
                color: "#1435c3",
                fontSize: 20,
      ...
      >
        ...
        <Col md={8} xs={24} style={{ width: "100%" }}>
          ...
          {product9.attributes.map((item, index) => (
            <Row
              key={index}
              style={{
                padding: 8,
