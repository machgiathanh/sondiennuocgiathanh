...
export default function hello() {
  const product13 = product_list[13];
  return (
    <div>
      ...
      >
        <Col md={8} xs={24}>
          <Gallery images={product13.gallery}></Gallery>
        </Col>
        <Col md={16} xs={24} gutter={15}>
          <div>
            <Typography.Title level={3}>{product13.name}</Typography.Title>
            <Typography
              style={{
                color: "#1435c3",
                fontSize: 20,
            ...
            <Typography.Text level={5}>
              <span style={{ textDecoration: "line-through", color: "#999" }}>
                {product13.price_sale}
              </span>
              {product13.discount_percent}
            </Typography.Text>
          </div>
          <h4>
      ...
      >
        ...
        <Col md={8} xs={24} style={{ width: "100%" }}>
          ...
          {product13.attributes.map((item, index) => (
            <Row
              style={{
                padding: 8,
